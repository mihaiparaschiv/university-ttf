...
/**
 * Tokenizes the input into paragraphs, using ICU4J's rule-based break iterator.
 * Rule file is adapted from the rule file used internally by the RBBI sentence
 * tokenizer.
 */
public class ParagraphTokenizer {
	...
	public ParagraphTokenizer() throws Exception {
		this("resources/paragraph_break_rules.txt");
	}
