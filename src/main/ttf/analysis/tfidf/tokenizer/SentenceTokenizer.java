...
/**
 * Tokenizes the input into sentences. Uses ICU4J's RuleBasedBreakIterator with
 * rule file adapted from a dump of RBBI.sentenceInstance.
 */
public class SentenceTokenizer {
	...
	public SentenceTokenizer() throws Exception {
		this("resources/sentence_break_rules.txt");
	}
